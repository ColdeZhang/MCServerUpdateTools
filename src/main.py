...
if __name__ == '__main__':
    # rootPath = input("请输入您的服务器根目录位置：")
    # world = input("想要重制哪个世界的无领地区块：")
    # whitelist = generateMcaWhitelist(convertAreaToChunk(getResidencesArea(findResidenceSavePath("../test_server", "world"))))
    # deleteUnusedMca("../test_server/world", whitelist)
    # backupRegionFiles(findWorldMCAPath(rootPath, world))
    backupRegionFiles("../test_server/world")
    # getAllWorlds("../test_server")
    # findResidenceSavePath("../test_server", "world")
    # restoreRegionBackup("../test_server/world")
    # backupRegionFiles("../test_server/world")
    deleteRegionBackup("../test_server/world")
